 ...
 */
public class ListRadioButtonsTagTest extends TagTestSupport<ListRadioButtonsTag> {

    public ListRadioButtonsTagTest() {
        super(new ListRadioButtonsTag());
    }
    ...
    public void testInputPageForAllSetting() throws Exception {
        ...
        String temp = Builder.lines(
                ...
                "dir=\"dir_test\"",
                "tabindex=\"5\"", // 出力されるすべてのinputタグに同一のtabindexが出力されることを確認する
                "type=\"radio\"",
                "name=\"name_test\"",
                "value=\"%s\"",
                "%s",
    ...
    public void testInputPageWithDefaultConfig() throws Exception {
        ...
        String temp = Builder.lines(
                ...
                "name=\"entity.bbb\"",
                "value=\"%s\"",
                "%s /><label class=\"default_error\" for=\"nablarch_radio%s\">%s</label>&nbsp;").replace(Builder.LS, " ");
        String checked = "checked=\"checked\"";
        String unchecked = "unchecked";
        int i = 0;
        String expected = Builder.lines(
    ...
    public void testInputPageBigDecimalLabel() throws Exception {
        ...
        String expected = Builder.lines(
                ...
                "name=\"name_test\"",
                "value=\"1\"",
                "checked=\"checked\" /><label for=\"nablarch_radio1\">0.0000000001</label><br />").replace(Builder.LS, " ");
        TagTestUtil.assertTag(actual, expected, " ");
    ...
    public void testInputPageBigDecimalValue() throws Exception {
        ...
        String expected = Builder.lines(
                ...
                "name=\"name_test\"",
                "value=\"0.0000000001\"",
                "checked=\"checked\" /><label for=\"nablarch_radio1\">testName</label><br />").replace(Builder.LS, " ");
        TagTestUtil.assertTag(actual, expected, " ");
        assertThat(formContext.getInputNames(), hasItem("name_test"));
    }
    ...
    public void testNotChildOfForm() throws Exception {
        ...
        try {
            ...
            assertThat(e.getMessage(), is("invalid location of the radioButtons tag. the radioButtons tag must locate in the form tag."));
        }
    }
