...
public abstract class TextTagTestSupport<T extends TextTag> extends TagTestSupport<T> {

    private String typeValue;

    public TextTagTestSupport(T target, String typeValue) {
        super(target);
    ...
    public void testNotChildOfForm() throws Exception {
        ...
        try {
            ...
            assertThat(e.getMessage(), is(
                    String.format("invalid location of the %s tag. the %s tag must locate in the form tag.", typeValue, typeValue)));
        }
    }
