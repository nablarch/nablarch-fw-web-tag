 ...
 */
public class CodeCheckboxesTagTest extends TagTestSupport<CodeCheckboxesTag> {

    public CodeCheckboxesTagTest() {
        super(new CodeCheckboxesTag());
    }
    ...
    public void testInputPageForAllSetting() throws Exception {
        ...
        String temp = Builder.lines(
                ...
                "dir=\"dir_test\"",
                "tabindex=\"3\"", // 出力されるすべてのinputタグに同一のtabindexが出力されることを確認する
                "type=\"checkbox\"",
                "name=\"name_test\"",
                "value=\"%s\"",
                "%s",
    ...
    public void testInputPageWithDefaultConfig() throws Exception {
        ...
        String temp = Builder.lines(
                ...
                "name=\"entity.bbb\"",
                "value=\"%s\"",
                "%s /><label class=\"default_error\" for=\"nablarch_checkbox%s\">%s</label></span>").replace(Builder.LS, " ");
        String checked = "checked=\"checked\"";
        String unchecked = "unchecked";
        int i = 0;
        String expected = Builder.lines(
    ...
    public void testNotChildOfForm() throws Exception {
        ...
        try {
            ...
            assertThat(e.getMessage(), is("invalid location of the codeCheckboxes tag. the codeCheckboxes tag must locate in the form tag."));
        }
    }
}
